...
"""
Prueba tu agente de Quinta Esmeralda sin necesitar WhatsApp.
...
# Forzar UTF-8 en la consola (Windows usa cp1252 por defecto y no soporta emojis)
...
async def main():
    ...
    print()
    print("=" * 55)
    print("   Quinta Esmeralda — Test Local del Agente")
    print("=" * 55)
    print()
